...
when defined(windows): 
  const 
    libmosquitto1* = "mosquitto1.dll"
elif defined(macosx): 
  const 
    libmosquitto1* = "libmosquitto1.so"
else: 
  const 
    libmosquitto1* = "libmosquitto.so.1"
...
const
  MOSQ_LOG_NONE* = 0x00000000
  MOSQ_LOG_INFO* = 0x00000001
  MOSQ_LOG_NOTICE* = 0x00000002
  MOSQ_LOG_WARNING* = 0x00000004
  MOSQ_LOG_ERR* = 0x00000008
  MOSQ_LOG_DEBUG* = 0x00000010
  MOSQ_LOG_SUBSCRIBE* = 0x00000020
  MOSQ_LOG_UNSUBSCRIBE* = 0x00000040
  MOSQ_LOG_WEBSOCKETS* = 0x00000080
  MOSQ_LOG_ALL* = 0x0000FFFF
...
type
  mosq_err_t* = enum
    ...
    MOSQ_ERR_TLS = 8, MOSQ_ERR_PAYLOAD_SIZE = 9, MOSQ_ERR_NOT_SUPPORTED = 10,
    MOSQ_ERR_AUTH = 11, MOSQ_ERR_ACL_DENIED = 12, MOSQ_ERR_UNKNOWN = 13,
    MOSQ_ERR_ERRNO = 14, MOSQ_ERR_EAI = 15, MOSQ_ERR_PROXY = 16
...
type
  mosquitto_message* {.bycopy.} = object
    mid*: cint
    topic*: cstring
    payload*: pointer
    payloadlen*: cint
...
proc mosquitto_lib_version*(major: ptr cint; minor: ptr cint; revision: ptr cint): cint {.cdecl, importc: "mosquitto_lib_version", dynlib: libmosquitto1.}
##
...
proc mosquitto_lib_init*(): cint {.cdecl, importc: "mosquitto_lib_init", dynlib: libmosquitto1.}
##
...
proc mosquitto_lib_cleanup*(): cint {.cdecl, importc: "mosquitto_lib_cleanup", dynlib: libmosquitto1.}
##
...
proc mosquitto_new*(id: cstring; clean_session: bool; obj: pointer): ptr mosquitto {.cdecl, importc: "mosquitto_new", dynlib: libmosquitto1.}
##
...
proc mosquitto_destroy*(mosq: ptr mosquitto) {.cdecl, importc: "mosquitto_destroy", dynlib: libmosquitto1.}
##
...
proc mosquitto_reinitialise*(mosq: ptr mosquitto; id: cstring; clean_session: bool;
                            obj: pointer): cint {.cdecl, importc: "mosquitto_reinitilise", dynlib: libmosquitto1.}
##
...
proc mosquitto_will_set*(mosq: ptr mosquitto; topic: cstring; payloadlen: cint;
                        payload: pointer; qos: cint; retain: bool): cint {.cdecl, importc: "mosquitto_will_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_will_clear*(mosq: ptr mosquitto): cint {.cdecl, importc: "mosquitto_will_clear", dynlib: libmosquitto1.}
##
...
proc mosquitto_username_pw_set*(mosq: ptr mosquitto; username: cstring;
                               password: cstring): cint {.cdecl, importc: "mosquitto_username_pw_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_connect*(mosq: ptr mosquitto; host: cstring; port: cint; keepalive: cint): cint {.cdecl, importc: "mosquitto_connect", dynlib: libmosquitto1.}
##
...
proc mosquitto_connect_bind*(mosq: ptr mosquitto; host: cstring; port: cint;
                            keepalive: cint; bind_address: cstring): cint {.cdecl, importc: "mosquitto_connect_bind", dynlib: libmosquitto1.}
##
...
proc mosquitto_connect_async*(mosq: ptr mosquitto; host: cstring; port: cint;
                             keepalive: cint): cint {.cdecl, importc: "mosquitto_connect_async", dynlib: libmosquitto1.}
##
...
proc mosquitto_connect_bind_async*(mosq: ptr mosquitto; host: cstring; port: cint;
                                  keepalive: cint; bind_address: cstring): cint {.cdecl, importc: "mosquitto_connect_bind_async", dynlib: libmosquitto1.}
##
...
proc mosquitto_connect_srv*(mosq: ptr mosquitto; host: cstring; keepalive: cint;
                           bind_address: cstring): cint {.cdecl, importc: "mosquitto_uer_data_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_reconnect*(mosq: ptr mosquitto): cint {.cdecl, importc: "mosquitto_reconnect", dynlib: libmosquitto1.}
##
...
proc mosquitto_reconnect_async*(mosq: ptr mosquitto): cint {.cdecl, importc: "mosquitto_reconnect_async", dynlib: libmosquitto1.}
##
...
proc mosquitto_disconnect*(mosq: ptr mosquitto): cint {.cdecl, importc: "mosquitto_disconnect", dynlib: libmosquitto1.}
##
...
proc mosquitto_publish*(mosq: ptr mosquitto; mid: ptr cint; topic: cstring;
                       payloadlen: cint; payload: pointer; qos: cint; retain: bool): cint {.cdecl, importc: "mosquitto_publish", dynlib: libmosquitto1.}
##
...
proc mosquitto_subscribe*(mosq: ptr mosquitto; mid: ptr cint; sub: cstring; qos: cint): cint {.cdecl, importc: "mosquitto_subscribe", dynlib: libmosquitto1.}
##
...
proc mosquitto_unsubscribe*(mosq: ptr mosquitto; mid: ptr cint; sub: cstring): cint {.cdecl, importc: "mosquitto_unsubscribe", dynlib: libmosquitto1.}
##
...
proc mosquitto_message_copy*(dst: ptr mosquitto_message; src: ptr mosquitto_message): cint {.cdecl, importc: "mosquitto_message_copy", dynlib: libmosquitto1.}
##
...
proc mosquitto_message_free*(message: ptr ptr mosquitto_message) {.cdecl, importc: "mosquitto_message_free", dynlib: libmosquitto1.}
##
...
proc mosquitto_loop*(mosq: ptr mosquitto; timeout: cint; max_packets: cint): cint {.cdecl, importc: "mosquitto_loop", dynlib: libmosquitto1.}
##
...
proc mosquitto_loop_forever*(mosq: ptr mosquitto; timeout: cint; max_packets: cint): cint {.cdecl, importc: "mosquitto_loop_forever", dynlib: libmosquitto1.}
##
...
proc mosquitto_loop_start*(mosq: ptr mosquitto): cint {.cdecl, importc: "mosquitto_loop_start", dynlib: libmosquitto1.}
##
...
proc mosquitto_loop_stop*(mosq: ptr mosquitto; force: bool): cint {.cdecl, importc: "mosquitto_loop_stop", dynlib: libmosquitto1.}
##
...
proc mosquitto_socket*(mosq: ptr mosquitto): cint {.cdecl, importc: "mosquitto_socket", dynlib: libmosquitto1.}
##
...
proc mosquitto_loop_read*(mosq: ptr mosquitto; max_packets: cint): cint {.cdecl, importc: "mosquitto_loop_read", dynlib: libmosquitto1.}
##
...
proc mosquitto_loop_write*(mosq: ptr mosquitto; max_packets: cint): cint {.cdecl, importc: "mosquitto_loop_write", dynlib: libmosquitto1.}
##
...
proc mosquitto_loop_misc*(mosq: ptr mosquitto): cint {.cdecl, importc: "mosquitto_lop_misc", dynlib: libmosquitto1.}
##
...
proc mosquitto_want_write*(mosq: ptr mosquitto): bool {.cdecl, importc: "mosquitto_want_write", dynlib: libmosquitto1.}
##
...
proc mosquitto_threaded_set*(mosq: ptr mosquitto; threaded: bool): cint {.cdecl, importc: "mosquitto_threadded_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_opts_set*(mosq: ptr mosquitto; option: mosq_opt_t; value: pointer): cint {.cdecl, importc: "mosquitto_opts_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_tls_set*(mosq: ptr mosquitto; cafile: cstring; capath: cstring;
                       certfile: cstring; keyfile: cstring; pw_callback: proc (
    buf: cstring; size: cint; rwflag: cint; userdata: pointer): cint): cint {.cdecl, importc: "mosquitto_tls_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_tls_insecure_set*(mosq: ptr mosquitto; value: bool): cint {.cdecl, importc: "mosquitto_tls_insecure_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_tls_opts_set*(mosq: ptr mosquitto; cert_reqs: cint;
                            tls_version: cstring; ciphers: cstring): cint {.cdecl, importc: "mosquitto_tls_opts_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_tls_psk_set*(mosq: ptr mosquitto; psk: cstring; identity: cstring;
                           ciphers: cstring): cint {.cdecl, importc: "mosquitto_tls_psk_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_connect_callback_set*(mosq: ptr mosquitto; on_connect: proc (
    a1: ptr mosquitto; a2: pointer; a3: cint)) {.cdecl, importc: "mosquitto_connect_callback_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_disconnect_callback_set*(mosq: ptr mosquitto; on_disconnect: proc (
    a1: ptr mosquitto; a2: pointer; a3: cint)) {.cdecl, importc: "mosquitto_disconnect_callback_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_publish_callback_set*(mosq: ptr mosquitto; on_publish: proc (
    a1: ptr mosquitto; a2: pointer; a3: cint)) {.cdecl, importc: "mosquitto_publish_callback_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_message_callback_set*(mosq: ptr mosquitto; on_message: proc (
    a1: ptr mosquitto; a2: pointer; a3: ptr mosquitto_message)) {.cdecl, importc: "mosquitto_message_callback_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_subscribe_callback_set*(mosq: ptr mosquitto; on_subscribe: proc (
    a1: ptr mosquitto; a2: pointer; a3: cint; a4: cint; a5: ptr cint)) {.cdecl, importc: "mosquitto_subscribe_callback_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_unsubscribe_callback_set*(mosq: ptr mosquitto; on_unsubscribe: proc (
    a1: ptr mosquitto; a2: pointer; a3: cint)) {.cdecl, importc: "mosquitto_unsubscribe_callback_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_log_callback_set*(mosq: ptr mosquitto; on_log: proc (a1: ptr mosquitto;
    a2: pointer; a3: cint; a4: cstring)) {.cdecl, importc: "mosquitto_log_callback_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_reconnect_delay_set*(mosq: ptr mosquitto; reconnect_delay: cuint;
                                   reconnect_delay_max: cuint;
                                   reconnect_exponential_backoff: bool): cint {.cdecl, importc: "mosquitto_reconnect_delay_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_message_retry_set*(mosq: ptr mosquitto; message_retry: cuint) {.cdecl, importc: "mosquitto_message_retry_set", dynlib: libmosquitto1.}
##
...
proc mosquitto_user_data_set*(mosq: ptr mosquitto; obj: pointer) {.cdecl, importc: "mosquitto_user_data_set", dynlib: libmosquitto1.}
##  =============================================================================
##
...
proc mosquitto_socks5_set*(mosq: ptr mosquitto; host: cstring; port: cint;
                          username: cstring; password: cstring): cint {.cdecl, importc: "mosquitto_socks5_set", dynlib: libmosquitto1.}
##  =============================================================================
##
...
proc mosquitto_strerror*(mosq_errno: cint): cstring {.cdecl, importc: "mosquitto_strerror", dynlib: libmosquitto1.}
##
...
proc mosquitto_connack_string*(connack_code: cint): cstring {.cdecl, importc: "mosquitto_connack_string", dynlib: libmosquitto1.}
##
...
proc mosquitto_sub_topic_tokenise*(subtopic: cstring; topics: ptr cstringArray;
                                  count: ptr cint): cint {.cdecl, importc: "mosquitto_sub_topic_tokenise", dynlib: libmosquitto1.}
##
...
proc mosquitto_sub_topic_tokens_free*(topics: ptr cstringArray; count: cint): cint {.cdecl, importc: "mosquitto_sub_topic_tokens_free", dynlib: libmosquitto1.}
##
...
proc mosquitto_topic_matches_sub*(sub: cstring; topic: cstring; result: ptr bool): cint {.cdecl, importc: "mosquitto_topic_matches_sub", dynlib: libmosquitto1.}
##
...
proc mosquitto_pub_topic_check*(topic: cstring): cint {.cdecl, importc: "mosquitto_pub_topic_check", dynlib: libmosquitto1.}
##
...
proc mosquitto_sub_topic_check*(topic: cstring): cint {.cdecl, importc: "mosquitto_sub_topic_check", dynlib: libmosquitto1.}